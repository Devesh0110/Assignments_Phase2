...
public class UpdateCustomer extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("update-customer.html").include(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Customer obj = new Customer(CustomerId, CustomerName, CustomerAge, CustomerDesc);
			...
			if(session != null ) {
				out.print("<h3 style='color:green'> Customer data is updated sucessfully ! </h3>");
			}
